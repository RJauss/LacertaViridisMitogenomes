...
```{r Plot Bayes tree, warning=FALSE, message=FALSE,fig.width = 8.5, fig.height = 8.5, dpi = 300}
...
In this chunck we plot the previously analysed constrained topologies and plot their significance next to it. This will later be a Supplementary Figure

```{r Constrained Topologies}
...
Here we plot the rate of transitions and transversions against the genetic distance to estimate if our dataset might be saturated

```{r Gene Saturation Test}
library(ape)
