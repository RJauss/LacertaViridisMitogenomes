...
rectdata = data.frame(Lineage = c("Lacerta viridis", 
...
rectdata[rectdata$Lineage == "Lacerta viridis", "xminval"] = min(which(grepl("Lv_(?!.*TR)", head(distmat_melted, n = 25)$Var1, perl = T)))-0.5
rectdata[rectdata$Lineage == "Lacerta viridis", "xmaxval"] = max(which(grepl("Lv_(?!.*TR)", head(distmat_melted, n = 25)$Var1, perl = T)))+0.5

rectdata[rectdata$Lineage == "Lacerta viridis (Turkey)", "xminval"] = min(which(grepl("Lv_TR", head(distmat_melted, n = 25)$Var1, perl = T)))-0.5
rectdata[rectdata$Lineage == "Lacerta viridis (Turkey)", "xmaxval"] = max(which(grepl("Lv_TR", head(distmat_melted, n = 25)$Var1, perl = T)))+0.5

rectdata[rectdata$Lineage == "Lacerta bilineata", "xminval"] = min(which(grepl("Lb_", head(distmat_melted, n = 25)$Var1, perl = T)))-0.5
rectdata[rectdata$Lineage == "Lacerta bilineata", "xmaxval"] = max(which(grepl("Lb_", head(distmat_melted, n = 25)$Var1, perl = T)))+0.5

rectdata[rectdata$Lineage == "Adriatic clade", "xminval"] = min(which(grepl("AL_", head(distmat_melted, n = 25)$Var1, perl = T)))-0.5
rectdata[rectdata$Lineage == "Adriatic clade", "xmaxval"] = max(which(grepl("AL_", head(distmat_melted, n = 25)$Var1, perl = T)))+0.5

rectdata[rectdata$Lineage == "Outgroups", "xminval"] = min(which(grepl("[KN]C", head(distmat_melted, n = 25)$Var1, perl = T)))-0.5
rectdata[rectdata$Lineage == "Outgroups", "xmaxval"] = max(which(grepl("[KN]C", head(distmat_melted, n = 25)$Var1, perl = T)))+0.5
